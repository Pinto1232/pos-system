  ...
  return (
    <Paper sx={{ p: 3, mb: 3 }}>
      ...
      <Typography variant="body2" color="text.secondary" paragraph>
        Use these controls to manually revalidate cached data in the application.
        This is useful when you've made changes that should be immediately visible to users.
      </Typography>
