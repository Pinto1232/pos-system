...
const JumbotronContainer: React.FC<JumbotronContainerProps> = ({ heading, subheading, backgroundImage, overlayColor }) => {
  ...
  return <Jumbotron heading={finalHeading} subheading={finalSubheading} backgroundImage={finalBackground} overlayColor={finalOverlay} />;
};
