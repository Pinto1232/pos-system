...
const CustomPackageLayout: React.FC<CustomPackageLayoutProps> = ({
  ...
  const handleAddOnToggle = (addOn: AddOn) => {
    ...
    console.log('AddOn being toggled:', JSON.stringify(addOn, null, 2));
    console.log('  ID:', JSON.stringify(addOn.id, null, 2));
    console.log('  Name:', JSON.stringify(addOn.name, null, 2));
  ...
  const handleSave = () => {
    ...
    console.log('Package data saved:', JSON.stringify(fullData, null, 2));
  ...
  const handleCheckboxChange = (id: string) => {
    const resetState = Object.keys(checkboxStates).reduce(
      (acc, key) => {
        acc[key] = false;
        return acc;
      },
            ...
            >
              {[
                ...
                >
                  ...
                  <Box
                    className={styles.paymentFeatures}
                    sx={{
                      flexGrow: 1,
                      display: 'flex',
                      flexDirection: 'column',
                  ...
                  >
                    {selectedPlanIndex === index ? 'SELECTED' : plan.buttonText}
                  </Button>
                </Box>
              ))}
            </Box>
          ...
          <Box className={styles.featuresContainer}>
            ...
            <Box className={styles.enterpriseFeaturesContainer}>
              <Box
                ...
                sx={{
                  opacity: isEnterpriseFeatureDisabled('analytics') ? 0.5 : 1,
                }}
              >
              ...
              <Box
                className={styles.enterpriseFeatureItem}
                sx={{
                  opacity: isEnterpriseFeatureDisabled('security') ? 0.5 : 1,
                }}
              >
                <Box className={styles.featureHeader}>
              ...
              <Box
                className={styles.enterpriseFeatureItem}
                sx={{
                  opacity: isEnterpriseFeatureDisabled('api') ? 0.5 : 1,
                }}
              >
                <Box className={styles.featureHeader}>
          ...
          <Box className={styles.reviewContainer}>
            ...
            <Box className={styles.reviewColumn}>
              <Box className={styles.orderSummary}>
                ...
                <Box
                  className={styles.orderSummaryContent}
                  sx={{
                    '& .MuiTypography-root': {
                      color: '#1a1a1a',
                    },
                  ...
                  <Box className={styles.section} sx={{ mb: 3 }}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          -{formatPrice(selectedCurrency, basePrice * 0.2)}
                          <span
                            style={{
                              fontSize: '0.85rem',
                              marginLeft: '2px',
                ...
                <Box
                  className={styles.orderSummaryFooter}
                  sx={{
                    borderTop: '1px solid',
                    borderColor: 'divider',
                    pt: 3,
                ...
                >
                  <Box className={styles.totalContainer} sx={{ mb: 3 }}>
