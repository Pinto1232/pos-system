...
export const TopLeftBadge = styled(Box)(
  ({ theme }) => ({
    position: 'absolute',
    top: theme.spacing(1),
...
export const TopRightIcon = styled(Box)(
  ({ theme }) => ({
    position: 'absolute',
    top: theme.spacing(1),
...
export const InfoLines = styled(Box)(
  ({ theme }) => ({
    display: 'flex',
...
export const BankCardContainer = styled(Box)(
  ({ theme }) => ({
    background:
    ...
    '&:hover': {
      ...
      boxShadow:
        '0 15px 30px rgba(30, 58, 138, 0.4)',
    },
  })
);
...
export const BankCardHeader = styled(Box)(
  ({ theme }) => ({
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
