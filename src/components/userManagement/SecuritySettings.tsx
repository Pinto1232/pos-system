...
> = ({ settings, onUpdateSettings }) => {
  const [formData, setFormData] =
    useState<SecuritySettingsType>(settings);
  ...
  const handleNumberChange = (
    ...
    setFormData((prev) => ({
      ...
      [section]: {
        ...prev[
          section as keyof SecuritySettingsType
        ],
    ...
    >
      <Box sx={{ mb: 3 }}>
        ...
        <Typography
          ...
          sx={{ mb: 2 }}
        >
          Configure security policies for your
          organization. These settings affect all
          users.
        </Typography>
      </Box>
        ...
        >
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={handleSwitchChange(
                      'passwordPolicy.twoFactorEnabled'
                    )}
                    color="primary"
                  />
                }
          ...
          {formData.passwordPolicy
            ...
            <Alert severity="info" sx={{ mt: 2 }}>
              ...
              users to provide a second form of
