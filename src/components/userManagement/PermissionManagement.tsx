    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          This section shows all available permissions grouped by module. Permissions define what actions users can perform in the system.
        </Typography>
      </Box>
      ...
      <Box sx={{ mt: 3, p: 2, bgcolor: '#f8f9fa', borderRadius: 2, border: '1px solid #e0e0e0' }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Permissions are assigned to roles, and roles are assigned to users. This creates a flexible system where you can define what actions different types of users can perform.
        </Typography>
        <Box sx={{ mt: 2 }}>
          ...
          <ul style={{ marginTop: 8, paddingLeft: 20 }}>
            <li>
              <Typography variant="body2">
                Create roles with specific sets of permissions
              </Typography>
            </li>
            <li>
              <Typography variant="body2">
            ...
            <li>
              <Typography variant="body2">
                Users will only be able to perform actions allowed by their permissions
              </Typography>
            </li>
          </ul>
        </Box>
