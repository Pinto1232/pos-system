...
function HeroContainer() {
  ...
  const subheading =
    'An all-in-one POS solution designed to streamline sales,  ' + 'manage inventory, and grow your business with ease.\n\n' + '';
  ...
  return <Hero heading={heading} subheading={subheading} ctaPrimary={ctaPrimary} ctaSecondary={ctaSecondary} ladyImage={ladyImage} />;
}
