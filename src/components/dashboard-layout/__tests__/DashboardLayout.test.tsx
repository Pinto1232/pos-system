...
jest.mock(
  '@/components/dashboardMain/dashboardMainContainer',
  () => {
    return function MockDashboardMainContainer(props: {
      ...
      return (
        <div data-testid="dashboard-main-container">
          <div data-testid="dashboard-main-props">
            {JSON.stringify(props)}
          </div>
        </div>
      );
  ...
  return function MockSettingsModal(props: {
    ...
    return (
      <div data-testid="settings-modal">
        <div data-testid="settings-modal-props">
          {JSON.stringify(props)}
        </div>
      </div>
    );
    ...
    await waitFor(() => {
      expect(global.fetch).toHaveBeenCalledWith(
        expect.stringMatching(
          /\/api\/UserCustomization\/test-user-id/
        )
      );
    });

    const settingsModalProps = screen.getByTestId(
      'settings-modal-props'
    );
    expect(
      settingsModalProps.textContent
    ).toContain('"userId":"test-user-id"');
  });
