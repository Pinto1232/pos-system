    ...
    <Box className={styles.testimonialContainer}>
      <Box className={styles.testimonialWrapper}>
        ...
        <Box className={styles.textSection}>
          ...
          >
            <Typography variant="h5" className={styles.testimonialHeading}>
              {sectionTitle}
            </Typography>

            <Typography variant="body1" className={styles.testimonialQuote}>
              {testimonialText.split('. ').map((sentence, index, array) => (
            ...
            <Box className={styles.clientInfo}>
              ...
              <Typography variant="body2" className={styles.clientPosition}>
                {clientPosition}
                <span className={styles.clientCompany}>{clientCompany}</span>
              </Typography>
            </Box>
          </Paper>
        </Box>
