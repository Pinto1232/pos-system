...
interface UserManagementContextType {
  ...
  assignRolesToUser: (userId: number, roles: string[]) => Promise<void>;

  // Role operations
  createRole: (roleData: RoleFormData) => Promise<Role>;
  updateRole: (id: number, roleData: RoleFormData) => Promise<void>;
...
export const UserManagementProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const mockModules: string[] = ['User Management', 'Product Management', 'Sales'];
  ...
  const updateRoleMutation = useMutation({
    mutationFn: ({ id, roleData }: { id: number; roleData: RoleFormData }) =>
  ...
  const assignPermissionsToRoleMutation = useMutation({
    mutationFn: ({ roleId, permissions }: { roleId: number; permissions: string[] }) =>
      api.assignPermissionsToRole(roleId, permissions),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['roles'] });
    },
  });
  ...
  const createUser = async (userData: UserFormData): Promise<User> => {
    try {
      ...
      console.log('Using mock createUser implementation');
  ...
  const updateUser = async (id: number, userData: UserFormData): Promise<void> => {
    try {
      return await updateUserMutation.mutateAsync({ id, userData });
    } catch (error) {
      console.log('Using mock updateUser implementation');
  ...
  const deleteUser = async (id: number): Promise<void> => {
    try {
      ...
      console.log('Using mock deleteUser implementation');
  ...
  const assignRolesToUser = async (userId: number, roles: string[]): Promise<void> => {
    try {
      return await assignRolesToUserMutation.mutateAsync({ userId, roles });
    } catch (error) {
      console.log('Using mock assignRolesToUser implementation');
  ...
  const createRole = async (roleData: RoleFormData): Promise<Role> => {
    try {
      ...
      console.log('Using mock createRole implementation');
  ...
  const updateRole = async (id: number, roleData: RoleFormData): Promise<void> => {
    try {
      return await updateRoleMutation.mutateAsync({ id, roleData });
    } catch (error) {
      console.log('Using mock updateRole implementation');
  ...
  const deleteRole = async (id: number): Promise<void> => {
    try {
      return await deleteRoleMutation.mutateAsync(id);
    } catch (error) {
      console.log('Using mock deleteRole implementation');
  ...
  const assignPermissionsToRole = async (roleId: number, permissions: string[]): Promise<void> => {
    try {
      return await assignPermissionsToRoleMutation.mutateAsync({ roleId, permissions });
    } catch (error) {
      console.log('Using mock assignPermissionsToRole implementation');
